...
//if no reported incidents it will show a default message
    if (response.incidents.length === 0) {
      ...
      pElem.addClass('text-4xl text-black text-center');
    ...
    incidentResponse.forEach(element => {
      ...
      if (element.media.image_url === null) {
        ...
        $(imgE1).attr("src", element.media.image_url)
      }
      ...
      if (element.description === "") {
        ...
        ($(pE1).text(element.description))
      }
      /*Build facebook share button*/
      $(pE1).append(divE4);
      $(divE4).addClass("fb-share-button mt-5");
      $(aE1).addClass("text-white");
      ...
      $(aE1).addClass("bg-blue-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-full");
